...
import { postMoment } from "../../api/moment";
      ...
      return (
        <div>
          <form action="" encType="multipart/form-data" style={{display: "none"}}>
              <input ref={this.fileRef} onChange={this.toPostMoment} maxLength={9-this.data.length}
    ...
    return (
      <div className="post-moment-wrap">
        <div className="topbar">
          ...
          <button className="send" onClick={this.sendMoment}>发表</button>
        </div>
        <Input
