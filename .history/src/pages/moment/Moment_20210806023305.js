    ...
    if(this.state.isShowInput) {
      return (
        <div className="comment-input">
          <Input className="textarea" autoSize value={this.state.value} maxRows={4}
            onChange={this.handleInput} name="" id="" placeholder="评论"></Input>
          <svg
            t="1627607851197"
            className="icon"
          ...
          <button className="btn" onClick={this.sendComment}>发送</button>
        </div>
      )
    }else {
      return
