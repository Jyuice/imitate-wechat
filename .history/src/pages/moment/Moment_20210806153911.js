...
export default class Moment extends Component {
  ...
  showInput = id => {
    // 收到要评论的moment_id
    console.log(id*1===this.momentToComment_id*1)
    this.setState({
      value: id === this.momentToComment_id ? this.state.value : "",
      isShowInput:
        id === this.momentToComment_id ? !this.state.isShowInput : true,
    });
    this.momentToComment_id = id;
  };
