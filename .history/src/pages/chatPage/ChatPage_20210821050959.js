...
export default class ChatPage extends Component {
  ...
  componentDidMount() {
    ...
    this.getSocket()
    this.scrollToBottom()
    this.container.addEventListener('scroll', this.doScroll)
  }

  scrollToBottom = () => {
      const scrollHeight = this.container.scrollHeight;//里面div的实际高度  2000px
      const height = this.container.clientHeight;  //网页可见高度  200px
      const maxScrollTop = scrollHeight - height; 
      this.container.scrollTop = this.container.offsetTop;
  ...
  render() {
    ...
    return (
      <div className="chat-page" onScroll={this.doScroll} ref={el => this.container = el}>
