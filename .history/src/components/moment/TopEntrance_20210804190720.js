...
class TopEntrance extends Component {
    ...
    doChangeBackground = () => {
        const form = this.bgRef.current
        console.log(form.files)
        // let formData = new FormData()
        // formData.append("userId",localStorage.getItem("userId"))
        // formData.append('background', form.file.files[0])
    ...
    render() {
        ...
        return (
            <div className="top">
                ...
                <form ref={this.formRef} action="" onChange={this.doChangeBackground} enctype="multipart/form-data" style={{display: "none"}}>
                    <input ref={this.bgRef} type="file" name="background" id="" />
                </form>
