...
class Identity extends Component {
    ...
    render() {
        const {nickname, avatar, wechat_Id} = this.state.info
        return (
            <div className="id-card" onClick={() => {
                this.props.history.push(`/individual/changeInfo`,{nickname: nickname,avatar: avatar,wechat_Id:wechat_Id})
                PubSub.publish("AVATAR",avatar)
